...
Dimensions::Dimensions()
{
    ...
    shcs.append(QList<double>({0, 0, 0}));
    ...
    shcs.append(QList<double>({inchTOmeter(0.164),
                               inchTOmeter(0.270),
                               inchTOmeter(9.0/64.0)}));
    ...
    shcs.append(QList<double>({inchTOmeter(0.190),
                               inchTOmeter(5.0/16.0),
                               inchTOmeter(5.0/32.0)}));
    ...
    shcs.append(QList<double>({inchTOmeter(0.250),
                               inchTOmeter(3.0/8.0),
                               inchTOmeter(3.0/16.0)}));
    ...
    shcs.append(QList<double>({inchTOmeter(5.0/16.0),
                               inchTOmeter(15.0/32.0),
                               inchTOmeter(0.250)}));
    ...
    shcs.append(QList<double>({inchTOmeter(3.0/8.0),
                               inchTOmeter(9.0/16.0),
                               inchTOmeter(5.0/16.0)}));
    ...
    shcs.append(QList<double>({inchTOmeter(7.0/16.0),
    ...
    shcs.append(QList<double>({inchTOmeter(21.0/32.0),  // NOT VALID
                               inchTOmeter(7.0/16.0),   // NOT VALID
                               inchTOmeter(3.0/8.0)})); // NOT VALID
    */
    ...
    shcs.append(QList<double>({4.0e-3, 7.0e-3, 3.0e-3}));
    ...
    shcs.append(QList<double>({5.0e-3, 8.5e-3, 4.0e-3}));
    ...
    shcs.append(QList<double>({6.0e-3, 10.0e-3, 5.0e-3}));
    ...
    shcs.append(QList<double>({8.0e-3, 13.0e-3, 6.0e-3}));
    ...
    shcs.append(QList<double>({10.0e-3, 16.0e-3, 8.0e-3}));
